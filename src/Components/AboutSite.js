                ...
                <div className="row  text-center  padding ">
                    <div className="col-xs-12 col-sm-12  col-md-3">
                        ...
                        <p>
                            ...
                            Language, the code that describes web pages.
                        </p>
                    </div>
                    <div className="col-xs-12 col-sm-12 col-md-3">
                    ...
                    <div className="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <p>
                            ...
                            HTML document. CSS describes how HTML elements
                            should be displayed.
                        </p>
                    </div>
                    <div className="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <p>
                            ...
                            used on the Web. It is used to enhance HTML pages
                            and is commonly found embedded in HTML code.
                        </p>
                    </div>
                    ...
                    <div className="row padding">
                        <div className="offset-lg-2 col-lg-4">
                            ...
                            <p>
                                ...
                                scripting and network security. The most common
                                languages used for Web programming are XML,
                                HTML, JavaScript, Perl 5 and PHP.
                            </p>
                            <br></br>
                            To improve user experience and related
                            functionalities on the client side, JavaScript is
                            usually used. It is an excellent client-side
                            platform for designing and implementing Web
                            applications.
                            <br></br>
