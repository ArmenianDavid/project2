    ...
    <React.Fragment>
      <div className="container-fluid">
       <div className="row text-center alert">
          ...
          <div className="col-12">
            <p className="lead"> Էջը Ստեղծվել է Դավիթ Սահակյանի կողմից և նախատեսված է որպես տեղեկատվական հարթակ ծառայելու բոլոր մեղր օգտագործողներին: Այն ներկայացնում է մի բրենդ, որը զբաղվում է մեղվապահությամբ և այդ բնության բարիքի վաճառքով:Էջը Ստեղծվել է Դավիթ Սահակյանի կողմից և նախատեսված է որպես տեղեկատվական հարթակ ծառայելու բոլոր մեղր օգտագործողներին: Այն ներկայացնում է մի բրենդ, որը զբաղվում է մեղվապահությամբ և այդ բնության բարիքի վաճառքով: </p>
          </div>
       </div>
     </div>
